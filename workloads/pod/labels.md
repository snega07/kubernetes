Selector in replicaset helps to connnect to the pod with matching labels and make sure desired number of replicas are running. Also ownerrefrence in replicaset says which deployment owns this replicaset. 
